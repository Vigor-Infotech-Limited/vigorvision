...
from vigorvision.data.utils import FORMATS_HELP_MSG, HELP_URL, IMG_FORMATS, check_file_speeds
from vigorvision.utils import DEFAULT_CFG, LOCAL_RANK, LOGGER, NUM_THREADS, TQDM
...
class BaseDataset(Dataset):
    ...
    def set_rectangle(self):
        """Set the shape of bounding boxes for Vision detections as rectangles."""
    ...
    def get_image_and_label(self, index):
        ...
        """
        label = deepcopy(self.labels[index])  # requires deepcopy() https://github.com/vigorvision/vigorvision/pull/1948
