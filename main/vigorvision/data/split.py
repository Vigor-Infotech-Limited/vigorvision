...
from vigorvision.data.utils import IMG_FORMATS, img2label_paths
from vigorvision.utils import DATASETS_DIR, LOGGER, TQDM
...
def autosplit(path=DATASETS_DIR / "coco8/images", weights=(0.9, 0.1, 0.0), annotated_only=False):
    ...
    Examples:
        >>> from vigorvision.data.split import autosplit
        >>> autosplit()
    """
