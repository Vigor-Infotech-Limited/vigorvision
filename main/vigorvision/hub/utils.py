...
from vigorvision.utils.downloads import GITHUB_ASSETS_NAMES
from vigorvision.utils.torch_utils import get_cpu_info

HUB_API_ROOT = os.environ.get("vigorvision_HUB_API", "https://api.vigorvision.com")
HUB_WEB_ROOT = os.environ.get("vigorvision_HUB_WEB", "https://hub.vigorvision.com")

PREFIX = colorstr("vigorvision HUB: ")
HELP_MSG = "If this issue persists please visit https://github.com/vigorvision/hub/issues for assistance."
...
class Events:
    ...
    def __init__(self):
        ...
        self.enabled = (
            ...
            and ONLINE
            and (IS_PIP_PACKAGE or get_git_origin_url() == "https://github.com/vigorvision/vigorvision.git")
        )
