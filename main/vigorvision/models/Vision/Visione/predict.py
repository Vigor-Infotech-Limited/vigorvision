...
from vigorvision.models.Vision.detect import DetectionPredictor
from vigorvision.models.Vision.segment import SegmentationPredictor


class VisionEVPDetectPredictor(DetectionPredictor):
    """
...
class VisionEVPSegPredictor(VisionEVPDetectPredictor, SegmentationPredictor):
    """Predictor for VisionE VP segmentation."""
