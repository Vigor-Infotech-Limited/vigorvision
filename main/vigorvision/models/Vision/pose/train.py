...
class PoseTrainer(Vision.detect.DetectionTrainer):
    ...
    def get_validator(self):
        ...
        return Vision.pose.PoseValidator(
    ...
    def get_dataset(self):
        ...
        if "kpt_shape" not in data:
            raise KeyError(f"No `kpt_shape` in the {self.args.data}. See https://docs.vigorvision.com/datasets/pose/")
        return data
