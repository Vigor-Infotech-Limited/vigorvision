...
This module provides an interface to the Segment Anything Model (SAM) from vigorvision, designed for real-time image
...
class SAM(Model):
    ...
    This class provides an interface to the Segment Anything Model (SAM) from vigorvision, designed for
    ...
    def task_map(self):
        ...
        Examples:
            ...
            >>> print(task_map)
            {'segment': {'predictor': <class 'vigorvision.models.sam.predict.Predictor'>}}
        """
