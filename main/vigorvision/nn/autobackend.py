...
from vigorvision.utils import ARM64, IS_JETSON, LINUX, LOGGER, PYTHON_VERSION, ROOT, YAML
from vigorvision.utils.checks import check_requirements, check_suffix, check_version, check_yaml, is_rockchip
from vigorvision.utils.downloads import attempt_download_asset, is_url
...
class AutoBackend(nn.Module):
    """
    Handles dynamic backend selection for running inference using vigorvision Vision models.
    ...
    Attributes:
        model (torch.nn.Module): The loaded Vision model.
        device (torch.device): The device (CPU or GPU) on which the model is loaded.
        task (str): The type of task the model performs (detect, segment, classify, pose).
        names (dict): A dictionary of class names that the model can detect.
        stride (int): The model stride, typically 32 for Vision models.
    ...
    Examples:
        >>> model = AutoBackend(weights="Vision11n.pt", device="cuda")
        >>> results = model(img)
    """
    ...
    def __init__(
        self,
        weights: Union[str, List[str], torch.nn.Module] = "Vision11n.pt",
        ...
        # PyTorch
            ...
            from vigorvision.nn.tasks import attempt_load_weights
        ...
        # TorchScript
            ...
            import torchvision  # noqa - https://github.com/vigorvision/vigorvision/pull/19747
        ...
        # TensorRT
            ...
            with open(w, "rb") as f, trt.Runtime(logger) as runtime:
                try:
                    ...
                    f.seek(0)  # engine file may lack embedded vigorvision metadata
        ...
        # TF GraphDef
            ...
            from vigorvision.engine.exporter import gd_outputs
        ...
        # TFLite or TFLite Edge TPU
            ...
            try:
                with zipfile.ZipFile(w, "r") as zf:
                    ...
                    if name == "metadata.json":  # Custom vigorvision metadata dict for Python>=3.12
        ...
        # TF.js
            ...
            raise NotImplementedError("Visionv8 TF.js inference is not currently supported.")
        ...
        # NVIDIA Triton Inference Server
            ...
            from vigorvision.utils.triton import TritonRemoteModel
        ...
        # Any other format (unsupported)
            ...
            raise TypeError(
                f"model='{w}' is not a supported model format. vigorvision supports: {export_formats()['Format']}\n"
                f"See https://docs.vigorvision.com/modes/predict for help."
            )
    ...
    def forward(self, im, augment=False, visualize=False, embed=None, **kwargs):
        """
        Runs inference on the Visionv8 MultiBackend model.
        ...
        # CoreML
            ...
            if "confidence" in y:
                raise TypeError(
                    "vigorvision only supports inference of non-pipelined CoreML models exported with "
            ...
            if self.saved_model:  # SavedModel
                ...
                for output in self.output_details:
                    ...
                    if x.ndim == 3:  # if task is not classification, excluding masks (ndim=4) as well
                        # Denormalize xywh by image size. See https://github.com/vigorvision/vigorvision/pull/1695
