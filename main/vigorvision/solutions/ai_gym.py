...
class AIGym(BaseSolution):
    ...
    This class extends BaseSolution to monitor workouts using Vision pose estimation models. It tracks and counts
    ...
    Examples:
        >>> gym = AIGym(model="Vision11n-pose.pt")
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            **kwargs (Any): Keyword arguments passed to the parent class constructor.
                model (str): Model name or path, defaults to "Vision11n-pose.pt".
        """
        kwargs["model"] = kwargs.get("model", "Vision11n-pose.pt")
    ...
    def process(self, im0):
        """
        Monitor workouts using vigorvision Vision Pose Model.

        This function processes an input image to track and analyze human poses for workout monitoring. It uses
        the Vision Pose model to detect keypoints, estimate angles, and count repetitions based on predefined
        angle thresholds.
