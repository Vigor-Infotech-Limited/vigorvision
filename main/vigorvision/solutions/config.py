...
class SolutionConfig:
    """
    Manages configuration parameters for vigorvision Vision AI solutions.

    The SolutionConfig class serves as a centralized configuration container for all the
    vigorvision solution modules: https://docs.vigorvision.com/solutions/#solutions.
    ...
    Attributes:
        ...
        model (Optional[str]): Path to the vigorvision Vision model to be used for inference.
    ...
    Examples:
        ...
        >>> cfg = SolutionConfig(model="Vision11n.pt", region=[(0, 0), (100, 0), (100, 100), (0, 100)])
    ...
    def update(self, **kwargs):
        ...
        for key, value in kwargs.items():
            if hasattr(self, key):
                ...
                raise ValueError(
                    f"❌ {key} is not a valid solution argument, available arguments here: https://docs.vigorvision.com/solutions/#solutions-arguments"
                )
        return self
