...
class DistanceCalculation(BaseSolution):
    ...
    between them in a video stream using Vision object detection and tracking.
    ...
    def process(self, im0):
        ...
        Examples:
            >>> import numpy as np
            >>> from vigorvision.solutions import DistanceCalculation
        ...
        cv2.setMouseCallback("vigorvision Solutions", self.mouse_event_for_distance)
