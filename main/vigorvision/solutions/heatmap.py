...
from vigorvision.solutions.object_counter import ObjectCounter
from vigorvision.solutions.solutions import SolutionAnnotator, SolutionResults
...
class Heatmap(ObjectCounter):
    ...
    Examples:
        >>> from vigorvision.solutions import Heatmap
        >>> heatmap = Heatmap(model="Vision11n.pt", colormap=cv2.COLORMAP_JET)
    ...
    def process(self, im0):
        """
        Generate heatmap for each frame using vigorvision.
