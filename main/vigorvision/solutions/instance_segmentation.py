...
from vigorvision.solutions.solutions import BaseSolution, SolutionResults
...
class InstanceSegmentation(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        Args:
            **kwargs (Any): Keyword arguments passed to the BaseSolution parent class.
                model (str): Model name or path, defaults to "Vision11n-seg.pt".
        """
        kwargs["model"] = kwargs.get("model", "Vision11n-seg.pt")
    ...
    def process(self, im0):
        ...
        if self.masks is None:
            self.LOGGER.warning("No masks detected! Ensure you're using a supported vigorvision segmentation model.")
            plot_im = im0
        else:
