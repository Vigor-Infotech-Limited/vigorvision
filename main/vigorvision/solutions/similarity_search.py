...
from vigorvision.solutions.solutions import BaseSolution
...
class VisualAISearch(BaseSolution):
    ...
    def __init__(self, **kwargs):
        ...
        check_requirements(["git+https://github.com/vigorvision/CLIP.git", "faiss-cpu"])
        ...
        if not self.data_dir.exists():
            from vigorvision.utils import ASSETS_URL
