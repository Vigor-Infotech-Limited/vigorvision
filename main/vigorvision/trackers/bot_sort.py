...
class BOTrack(STrack):
    """
    An extended version of the STrack class for Vision, adding object tracking features.
...
class BOTSORT(BYTETracker):
    """
    An extended version of the BYTETracker class for Vision, designed for object tracking with ReID and GMC algorithm.
    ...
    Methods:
        ...
        multi_predict: Predict and track multiple objects with a Vision model.
    ...
    Note:
        The class is designed to work with a Vision object detection model and supports ReID only if enabled via args.
    """
...
class ReID:
    """Vision model as encoder for re-identification."""
