...
from vigorvision.utils import LOGGER, SETTINGS, TESTS_RUNNING, checks
...
def on_pretrain_routine_start(trainer) -> None:
    ...
    try:
        ...
        LOGGER.info("DVCLive is detected and auto logging is enabled (run 'Vision settings dvc=False' to disable).")
...
def on_train_end(trainer) -> None:
    ...
    Examples:
        ...
        >>> from vigorvision.utils.callbacks.dvc import on_train_end
