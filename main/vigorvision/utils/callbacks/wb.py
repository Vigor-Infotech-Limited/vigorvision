...
from vigorvision.utils import SETTINGS, TESTS_RUNNING
...
def _custom_table(x, y, classes, title="Precision Recall Curve", x_title="Recall", y_title="Precision"):
    ...
    """
    import pandas  # scope for faster 'import vigorvision'
...
def on_pretrain_routine_start(trainer):
    ...
    if not wb.run:
        wb.init(
            project=str(trainer.args.project).replace("/", "-") if trainer.args.project else "vigorvision",
