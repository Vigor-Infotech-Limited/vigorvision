...
from vigorvision.utils import emojis


class HUBModelError(Exception):
    """
    Exception raised when a model cannot be found or retrieved from vigorvision HUB.

    This custom exception is used specifically for handling errors related to model fetching in vigorvision Vision.
    ...
    def __init__(self, message="Model not found. Please check model URL and try again."):
        ...
        This exception is raised when a requested model is not found or cannot be retrieved from vigorvision HUB.
