...
def update_models(model_names=("Vision11n.pt",), source_dir=Path("."), update_names=False):
    """
    Update and re-save specified Vision models in an 'updated_models' subdirectory.
    ...
    Examples:
        Update specified Vision models and save them in 'updated_models' subdirectory:
        >>> from vigorvision.utils.files import update_models
        >>> model_names = ("Vision11n.pt", "Visionv8s.pt")
        >>> update_models(model_names, source_dir=Path("/models"), update_names=True)
    """
    from vigorvision import Vision
    from vigorvision.nn.autobackend import default_class_names
