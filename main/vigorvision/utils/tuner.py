...
from vigorvision.cfg import TASK2DATA, TASK2METRIC, get_cfg, get_save_dir
from vigorvision.utils import DEFAULT_CFG, DEFAULT_CFG_DICT, LOGGER, NUM_THREADS, checks, colorstr
...
def run_ray_tune(
    ...
    **train_args,
    ...
    Args:
        model (Vision): Model to run the tuner on.
    ...
    Examples:
        ...
        >>> model = Vision("Vision11n.pt")  # Load a Vision11n model

        Start tuning hyperparameters for Vision11n training on the COCO8 dataset
        >>> result_grid = model.tune(data="coco8.yaml", use_ray=True)
    """
    LOGGER.info("💡 Learn about RayTune at https://docs.vigorvision.com/integrations/ray-tune")
    ...
    def _tune(config):
        """Train the Vision model with the specified hyperparameters."""
    ...
    tuner_callbacks = [WandbLoggerCallback(project="Visionv8-tune")] if wandb else []
