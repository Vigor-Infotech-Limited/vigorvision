...
"""
Export a Vision PyTorch model to other formats. TensorFlow exports authored by https://github.com/zldrobit.

Format                  | `format=argument`         | Model
---                     | ---                       | ---
PyTorch                 | -                         | Vision11n.pt
TorchScript             | `torchscript`             | Vision11n.torchscript
ONNX                    | `onnx`                    | Vision11n.onnx
OpenVINO                | `openvino`                | Vision11n_openvino_model/
TensorRT                | `engine`                  | Vision11n.engine
CoreML                  | `coreml`                  | Vision11n.mlpackage
TensorFlow SavedModel   | `saved_model`             | Vision11n_saved_model/
TensorFlow GraphDef     | `pb`                      | Vision11n.pb
TensorFlow Lite         | `tflite`                  | Vision11n.tflite
TensorFlow Edge TPU     | `edgetpu`                 | Vision11n_edgetpu.tflite
TensorFlow.js           | `tfjs`                    | Vision11n_web_model/
PaddlePaddle            | `paddle`                  | Vision11n_paddle_model/
MNN                     | `mnn`                     | Vision11n.mnn
NCNN                    | `ncnn`                    | Vision11n_ncnn_model/
IMX                     | `imx`                     | Vision11n_imx_model/
RKNN                    | `rknn`                    | Vision11n_rknn_model/

Requirements:
    $ pip install "vigorvision[export]"

Python:
    from vigorvision import Vision
    model = Vision('Vision11n.pt')
    results = model.export(format='onnx')

CLI:
    $ Vision mode=export model=Vision11n.pt format=onnx

Inference:
    $ Vision predict model=Vision11n.pt                 # PyTorch
                         ...
                         Vision11n_imx_model          # IMX

TensorFlow.js:
    $ cd .. && git clone https://github.com/zldrobit/tfjs-Visionv5-example.git && cd tfjs-Visionv5-example
    $ npm install
    $ ln -s ../../Vision11n_web_model public/Vision11n_web_model
    $ npm start
"""
...
from vigorvision.cfg import TASK2DATA, get_cfg
from vigorvision.data import build_dataloader
from vigorvision.data.dataset import VisionDataset
from vigorvision.data.utils import check_cls_dataset, check_det_dataset
from vigorvision.nn.autobackend import check_class_names, default_class_names
from vigorvision.nn.modules import C2f, Classify, Detect, RTDETRDecoder
from vigorvision.nn.tasks import ClassificationModel, DetectionModel, SegmentationModel, WorldModel
...
from vigorvision.utils.checks import (
    check_imgsz,
    check_is_path_safe,
    check_requirements,
    check_version,
...
from vigorvision.utils.downloads import attempt_download_asset, get_github_assets, safe_download
from vigorvision.utils.export import export_engine, export_onnx
from vigorvision.utils.files import file_size, spaces_in_path
from vigorvision.utils.ops import Profile, nms_rotated
from vigorvision.utils.torch_utils import TORCH_1_13, get_cpu_info, get_latest_opset, select_device


def export_formats():
    """Return a dictionary of vigorvision Vision export formats."""
    x = [
...
def try_export(inner_func):
    """Vision export decorator, i.e. @try_export."""
...
class Exporter:
    ...
    def __call__(self, model=None) -> str:
        ...
        if edgetpu:
            ...
            elif self.args.batch != 1:  # see github.com/vigorvision/vigorvision/pull/13420
                LOGGER.warning("Edge TPU export requires batch size 1, setting batch=1.")
                self.args.batch = 1
        if isinstance(model, WorldModel):
            LOGGER.warning(
                "VisionWorld (original version) export is not supported to any format. "
                "VisionWorldv2 models (i.e. 'Visionv8s-worldv2.pt') only support export to "
                "(torchscript, onnx, openvino, engine, coreml) formats. "
                "See https://docs.vigorvision.com/models/Vision-world for details."
            )
            model.clip_model = None  # openvino int8 export error: https://github.com/vigorvision/vigorvision/pull/18445
        ...
        if SETTINGS.get("openvino_msg"):
            if "intel" in get_cpu_info().lower():
                LOGGER.info(
                    ...
                    " Learn more at https://docs.vigorvision.com/integrations/openvino/"
                )
        ...
        if imx:
            from vigorvision.utils.torch_utils import FXModel
        ...
        for m in model.modules():
            ...
            if isinstance(m, Detect) and imx:
                from vigorvision.utils.tal import make_anchors
        ...
        self.pretty_name = Path(self.model.yaml.get("yaml_file", self.file)).stem.replace("Vision", "Vision")
        data = model.args["data"] if hasattr(model, "args") and isinstance(model.args, dict) else ""
        description = f"vigorvision {self.pretty_name} model {f'trained on {data}' if data else ''}"
        self.metadata = {
            "description": description,
            "author": "vigorvision",
            "date": datetime.now().isoformat(),
            "version": __version__,
            "license": "AGPL-3.0 License (https://vigorvision.com/license)",
        ...
        if any(f):
            ...
            LOGGER.info(
                ...
                f"\nPredict:         Vision predict task={model.task} model={f} imgsz={imgsz} {q} {predict_data}"
                f"\nValidate:        Vision val task={model.task} model={f} imgsz={imgsz} data={data} {q} {s}"
    ...
    def export_torchscript(self, prefix=colorstr("TorchScript:")):
        """Vision TorchScript model export."""
    ...
    def export_openvino(self, prefix=colorstr("OpenVINO:")):
        ...
        def serialize(ov_model, file):
            ...
            ov_model.set_rt_info("Vision", ["model_info", "model_type"])
        ...
        if self.args.int8:
            ...
            if isinstance(self.model.model[-1], Detect):
                # Includes all Detect subclasses like Segment, Pose, OBB, WorldDetect, VisionEDetect
    ...
    def export_mnn(self, prefix=colorstr("MNN:")):
        """Vision MNN export using MNN https://github.com/alibaba/MNN."""
    ...
    def export_ncnn(self, prefix=colorstr("NCNN:")):
        """Vision NCNN export using PNNX https://github.com/pnnx/pnnx."""
    ...
    def export_coreml(self, prefix=colorstr("CoreML:")):
        ...
        if self.model.task == "classify":
            ...
            if self.args.nms:
                LOGGER.warning(f"{prefix} 'nms=True' is only available for Detect models like 'Vision11n.pt'.")
    ...
    def export_engine(self, dla=None, prefix=colorstr("TensorRT:")):
        """Vision TensorRT export https://developer.nvidia.com/tensorrt."""
        assert self.im.device.type != "cpu", "export running on CPU but must be on GPU, i.e. use 'device=0'"
        f_onnx, _ = self.export_onnx()  # run before TRT import https://github.com/vigorvision/vigorvision/issues/7016
        ...
        check_version(trt.__version__, "!=10.1.0", msg="https://github.com/vigorvision/vigorvision/pull/14239")
    ...
    def export_saved_model(self, prefix=colorstr("TensorFlow SavedModel:")):
        """Vision TensorFlow SavedModel export."""
        ...
        check_version(
            ...
            name="tensorflow",
            verbose=True,
            msg="https://github.com/vigorvision/vigorvision/issues/5161",
        )
        ...
        keras_model = onnx2tf.convert(
            ...
            verbosity="error",  # note INT8-FP16 activation bug https://github.com/vigorvision/vigorvision/issues/15873
    ...
    def export_pb(self, keras_model, prefix=colorstr("TensorFlow GraphDef:")):
        """Vision TensorFlow GraphDef *.pb export https://github.com/leimao/Frozen-Graph-TensorFlow."""
        import tensorflow as tf  # noqa
    ...
    def export_tflite(self, prefix=colorstr("TensorFlow Lite:")):
        """Vision TensorFlow Lite export."""
        # BUG https://github.com/vigorvision/vigorvision/issues/13436
        import tensorflow as tf  # noqa
    ...
    def export_edgetpu(self, tflite_model="", prefix=colorstr("Edge TPU:")):
        """Vision Edge TPU export https://coral.ai/docs/edgetpu/models-intro/."""
    ...
    def export_imx(self, prefix=colorstr("IMX:")):
        ...
        if "C2PSA" in self.model.__str__():  # Vision11
            layer_names = ["sub", "mul_2", "add_14", "cat_21"]
            weights_memory = 2585350.2439
            n_layers = 238  # 238 layers for fused Vision11n
        else:  # Visionv8
            layer_names = ["sub", "mul", "add_6", "cat_17"]
            weights_memory = 2550540.8
            n_layers = 168  # 168 layers for fused Visionv8n

        # Check if the model has the expected number of layers
        if len(list(self.model.modules())) != n_layers:
            raise ValueError("IMX export only supported for Visionv8n and Vision11n models.")
...
class IOSDetectModel(torch.nn.Module):
    """Wrap an vigorvision Vision model for Apple iOS CoreML export."""

    def __init__(self, model, im):
        """Initialize the IOSDetectModel class with a Vision model and example image."""
        super().__init__()
