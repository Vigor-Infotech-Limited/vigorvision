...
Usage - sources:
    $ Vision mode=predict model=Vision11n.pt source=0                               # webcam
                                                img.jpg                         # image
                                                vid.mp4                         # video
                                                screen                          # screenshot
                                                path/                           # directory
...
Usage - formats:
    $ Vision mode=predict model=Vision11n.pt                 # PyTorch
...
from vigorvision.data import load_inference_source
from vigorvision.data.augment import LetterBox
from vigorvision.nn.autobackend import AutoBackend
from vigorvision.utils import DEFAULT_CFG, LOGGER, MACOS, WINDOWS, callbacks, colorstr, ops
from vigorvision.utils.checks import check_imgsz, check_imshow
...
errors for large sources or long-running streams and videos. See https://docs.vigorvision.com/modes/predict/ for help.
...
class BasePredictor:
    ...
    def __call__(self, source=None, model=None, stream=False, *args, **kwargs):
        ...
        Returns:
            (List[vigorvision.engine.results.Results] | generator): Results objects or generator of Results objects.
        """
        self.stream = stream
        if stream:
    ...
    def stream_inference(self, source=None, model=None, *args, **kwargs):
        ...
        Yields:
            (vigorvision.engine.results.Results): Results objects.
        """
    ...
    def setup_model(self, model, verbose=True):
        """
        Initialize Vision model with given parameters and set it to evaluation mode.
