...
"""
vigorvision Results, Boxes and Masks classes for handling inference results.

Usage: See https://docs.vigorvision.com/modes/predict/
"""
...
from vigorvision.utils import LOGGER, DataExportMixin, SimpleClass, ops
from vigorvision.utils.plotting import Annotator, colors, save_one_box
from vigorvision.utils.torch_utils import smart_inference_mode
...
class BaseTensor(SimpleClass):
    ...
    def cuda(self):
        ...
        Examples:
            >>> import torch
            >>> from vigorvision.engine.results import BaseTensor
            >>> data = torch.tensor([[1, 2, 3], [4, 5, 6]])
            >>> base_tensor = BaseTensor(data, orig_shape=(720, 1280))
            >>> gpu_tensor = base_tensor.cuda()
...
class Results(SimpleClass, DataExportMixin):
    ...
    vigorvision models, including detection, segmentation, classification, and pose estimation.
...
class Masks(BaseTensor):
    ...
    def __init__(self, masks, orig_shape) -> None:
        ...
        Examples:
            >>> import torch
            >>> from vigorvision.engine.results import Masks
...
class Keypoints(BaseTensor):
    ...
    Examples:
        >>> import torch
        >>> from vigorvision.engine.results import Keypoints
