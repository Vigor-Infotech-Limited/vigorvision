...
"""
Module provides functionalities for hyperparameter tuning of the vigorvision Vision models for object detection, instance
segmentation, image classification, pose estimation, and multi-object tracking.

Hyperparameter tuning is the process of systematically searching for the optimal set of hyperparameters
that yield the best model performance. This is particularly crucial in deep learning models like Vision,
where small changes in hyperparameters can lead to significant differences in model accuracy and efficiency.

Examples:
    Tune hyperparameters for Vision11n on COCO8 at imgsz=640 and epochs=30 for 300 tuning iterations.
...
from vigorvision.utils import DEFAULT_CFG, LOGGER, YAML, callbacks, colorstr, remove_colorstr
from vigorvision.utils.plotting import plot_tune_results


class Tuner:
    """
    A class for hyperparameter tuning of Vision models.

    The class evolves Vision model hyperparameters over a given number of iterations by mutating them according to the
    ...
    def __init__(self, args=DEFAULT_CFG, _callbacks=None):
        ...
        LOGGER.info(
            ...
            f"{self.prefix}💡 Learn about tuning at https://docs.vigorvision.com/guides/hyperparameter-tuning"
        )
    ...
    def __call__(self, model=None, iterations=10, cleanup=True):
        ...
        3. Train a Vision model with the mutated hyperparameters.
        4. Log the fitness score and mutated hyperparameters to a CSV file.

        Args:
            model (Model): A pre-initialized Vision model to be used for training.
        ...
        for i in range(start, iterations):
            ...
            try:
                # Train Vision model with mutated hyperparameters (run in subprocess to avoid dataloader hang)
                launch = [__import__("sys").executable, "-m", "vigorvision.cfg.__init__"]  # workaround Vision not found
