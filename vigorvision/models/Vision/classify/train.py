...
from vigorvision.data import ClassificationDataset, build_dataloader
from vigorvision.engine.trainer import BaseTrainer
from vigorvision.models import Vision
from vigorvision.nn.tasks import ClassificationModel
from vigorvision.utils import DEFAULT_CFG, LOGGER, RANK
from vigorvision.utils.plotting import plot_images, plot_results
from vigorvision.utils.torch_utils import is_parallel, strip_optimizer, torch_distributed_zero_first
...
class ClassificationTrainer(BaseTrainer):
    ...
    def set_model_attributes(self):
        """Set the Vision model's class names from the loaded dataset."""
    ...
    def get_validator(self):
        ...
        return Vision.classify.ClassificationValidator(
