...
from vigorvision.data import build_dataloader, build_Vision_dataset, converter
from vigorvision.engine.validator import BaseValidator
from vigorvision.utils import LOGGER, ops
from vigorvision.utils.checks import check_requirements
from vigorvision.utils.metrics import ConfusionMatrix, DetMetrics, box_iou
from vigorvision.utils.plotting import output_to_target, plot_images
...
class DetectionValidator(BaseValidator):
    ...
    Examples:
        ...
        >>> args = dict(model="Vision11n.pt", data="coco8.yaml")
    ...
    def preprocess(self, batch):
        """
        Preprocess batch of images for Vision validation.
    ...
    def init_metrics(self, model):
        """
        Initialize evaluation metrics for Vision detection validation.
    ...
    def get_desc(self):
        """Return a formatted string summarizing class metrics of Vision model."""
    ...
    def build_dataset(self, img_path, mode="val", batch=None):
        ...
        """
        return build_Vision_dataset(self.args, img_path, batch, self.data, mode=mode, stride=self.stride)
    ...
    def pred_to_json(self, predn, filename):
        """
        Serialize Vision predictions to COCO json format.
    ...
    def eval_json(self, stats):
        """
        Evaluate Vision output in JSON format and return performance statistics.
