...
from vigorvision.nn.tasks import OBBModel
from vigorvision.utils import DEFAULT_CFG, RANK


class OBBTrainer(Vision.detect.DetectionTrainer):
    """
    ...
    Methods:
        ...
        get_validator: Return an instance of OBBValidator for validation of Vision model.

    Examples:
        >>> from vigorvision.models.Vision.obb import OBBTrainer
        >>> args = dict(model="Vision11n-obb.pt", data="dota8.yaml", epochs=3)
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        ...
        Examples:
            >>> trainer = OBBTrainer()
            >>> model = trainer.get_model(cfg="Vision11n-obb.yaml", weights="Vision11n-obb.pt")
        """
    ...
    def get_validator(self):
        """Return an instance of OBBValidator for validation of Vision model."""
        self.loss_names = "box_loss", "cls_loss", "dfl_loss"
        return Vision.obb.OBBValidator(
