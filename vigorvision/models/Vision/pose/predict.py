...
from vigorvision.utils import DEFAULT_CFG, LOGGER, ops
...
class PosePredictor(DetectionPredictor):
    ...
    Attributes:
        ...
        model (torch.nn.Module): The loaded Vision pose model with keypoint detection capabilities.
    ...
    Examples:
        ...
        >>> from vigorvision.models.Vision.pose import PosePredictor
        >>> args = dict(model="Vision11n-pose.pt", source=ASSETS)
