...
from vigorvision.nn.tasks import SegmentationModel
...
class SegmentationTrainer(Vision.detect.DetectionTrainer):
    ...
    Examples:
        ...
        >>> args = dict(model="Vision11n-seg.pt", data="coco8-seg.yaml", epochs=3)
    ...
    def get_model(self, cfg=None, weights=None, verbose=True):
        ...
        Examples:
            ...
            >>> model = trainer.get_model(cfg="Vision11n-seg.yaml")
            >>> model = trainer.get_model(weights="Vision11n-seg.pt", verbose=False)
        """
    ...
    def get_validator(self):
        """Return an instance of SegmentationValidator for validation of Vision model."""
        self.loss_names = "box_loss", "seg_loss", "cls_loss", "dfl_loss"
        return Vision.segment.SegmentationValidator(
