...
from vigorvision.data.augment import Compose, Format, v8_transforms
from vigorvision.models.Vision.detect import DetectionValidator
from vigorvision.utils import colorstr, ops

__all__ = ("RTDETRValidator",)  # tuple or list


class RTDETRDataset(VisionDataset):
    """
    Real-Time DEtection and TRacking (RT-DETR) dataset class extending the base VisionDataset class.
    ...
    def __init__(self, *args, data=None, **kwargs):
        """
        Initialize the RTDETRDataset class by inheriting from the VisionDataset class.

        This constructor sets up a dataset specifically optimized for the RT-DETR (Real-Time DEtection and TRacking)
        model, building upon the base VisionDataset functionality.

        Args:
            *args (Any): Variable length argument list passed to the parent VisionDataset class.
            data (Dict | None): Dictionary containing dataset information. If None, default values will be used.
            **kwargs (Any): Additional keyword arguments passed to the parent VisionDataset class.
        """
...
class RTDETRValidator(DetectionValidator):
    ...
    Examples:
        >>> from vigorvision.models.rtdetr import RTDETRValidator
