...
using SAM. It forms an integral part of the vigorvision framework and is designed for high-performance, real-time image
segmentation tasks.
"""
...
class Predictor(BasePredictor):
    ...
    def setup_model(self, model=None, verbose=True):
        ...
        parameters for image normalization and other vigorvision compatibility settings.
        ...
        # vigorvision compatibility settings
        self.model.pt = False
