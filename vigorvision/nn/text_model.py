...
from vigorvision.utils import checks
from vigorvision.utils.torch_utils import smart_inference_mode

try:
    import clip
except ImportError:
    checks.check_requirements("git+https://github.com/vigorvision/CLIP.git")
    import clip
...
class CLIP(TextModel):
    ...
    Examples:
        >>> from vigorvision.models.sam import CLIP
        >>> import torch
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> import torch
            >>> from vigorvision.models.sam.modules.clip import CLIP
...
class MobileCLIP(TextModel):
    ...
    def __init__(self, size, device):
        ...
        Examples:
            >>> from vigorvision.nn.modules import MobileCLIP
            >>> import torch
        ...
        try:
            ...
            # vigorvision fork preferred since Apple MobileCLIP repo has incorrect version of torchvision
            checks.check_requirements("git+https://github.com/vigorvision/mobileclip.git")
            import mobileclip
        ...
        if not Path(file).is_file():
            from vigorvision import download
