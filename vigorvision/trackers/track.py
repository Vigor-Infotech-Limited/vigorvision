...
from vigorvision.utils import YAML, IterableSimpleNamespace
from vigorvision.utils.checks import check_yaml
...
def on_predict_start(predictor: object, persist: bool = False) -> None:
    ...
    if cfg.tracker_type == "botsort" and cfg.with_reid and cfg.model == "auto":
        from vigorvision.nn.modules.head import Detect
...
def register_tracker(model: object, persist: bool) -> None:
    ...
    Examples:
        Register tracking callbacks to a Vision model
        >>> model = VisionModel()
