...
"""Base callbacks for vigorvision training, validation, prediction, and export processes."""
...
def get_default_callbacks():
    """
    Get the default callbacks for vigorvision training, validation, prediction, and export processes.
