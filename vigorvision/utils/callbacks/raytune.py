...
from vigorvision.utils import SETTINGS
...
def on_fit_epoch_end(trainer):
    ...
    Args:
        trainer (vigorvision.engine.trainer.BaseTrainer): The vigorvision trainer object containing metrics and epochs.

    Examples:
        >>> # Called automatically by the vigorvision training loop
