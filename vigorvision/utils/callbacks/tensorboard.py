...
from vigorvision.utils import LOGGER, SETTINGS, TESTS_RUNNING, colorstr, torch_utils
...
def _log_tensorboard_graph(trainer) -> None:
    ...
    tensor. It first tries a simple method suitable for Vision models, and if that fails, falls back to a more complex
    ...
    with warnings.catch_warnings():
        ...
        # Try simple method first (Vision)
        try:
