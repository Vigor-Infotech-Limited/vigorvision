...
from vigorvision.utils import IS_JETSON, LOGGER
...
def export_engine(
    ...
    """
    Exports a Vision model to TensorRT engine format.
    ...
    Args:
        ...
        dataset (vigorvision.data.build.InfiniteDataLoader, optional): Dataset for INT8 calibration. Defaults to None.
    ...
    if int8:
        ...
        class EngineCalibrator(trt.IInt8Calibrator):
            ...
            def __init__(
                self,
                dataset,  # vigorvision.data.build.InfiniteDataLoader
                cache: str = "",
            ) -> None:
