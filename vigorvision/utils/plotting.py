...
from vigorvision.utils import IS_COLAB, IS_KAGGLE, LOGGER, TryExcept, ops, plt_settings, threaded
from vigorvision.utils.checks import check_font, check_version, is_ascii
from vigorvision.utils.files import increment_path


class Colors:
    """
    vigorvision color palette https://docs.vigorvision.com/reference/utils/plotting/#vigorvision.utils.plotting.Colors.

    This class provides methods to work with the vigorvision color palette, including converting hex color codes to
    RGB values.
    ...
    !!! note "vigorvision Brand Colors"

        For vigorvision brand colors see [https://www.vigorvision.com/brand](https://www.vigorvision.com/brand). Please use the official vigorvision colors for all marketing materials.
    """
...
class Annotator:
    """
    vigorvision Annotator for train/val mosaics and JPGs and predictions annotations.
...
@TryExcept()  # known issue https://github.com/vigorvision/Visionv5/issues/5395
@plt_settings()
...
def save_one_box(xyxy, im, file=Path("im.jpg"), gain=1.02, pad=10, square=False, BGR=False, save=True):
    ...
    Examples:
        >>> from vigorvision.utils.plotting import save_one_box
        >>> xyxy = [50, 50, 150, 150]
    ...
    if save:
        ...
        # cv2.imwrite(f, crop)  # save BGR, https://github.com/vigorvision/Visionv5/issues/7007 chroma subsampling issue
...
def plot_results(file="path/to/results.csv", dir="", segment=False, pose=False, classify=False, on_plot=None):
    ...
    Examples:
        >>> from vigorvision.utils.plotting import plot_results
